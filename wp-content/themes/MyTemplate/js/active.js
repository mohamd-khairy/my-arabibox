(function($) {
    ...
    $('.center').slick({
        ...
        slidesToShow: 3,
        arrows: true,
        prevArrow: '<button type="button" class="wen-slick-prev"><i class="fa fa-chevron-left"></i></button>',
        nextArrow: '<button type="button" class="wen-slick-next"><i class="fa fa-chevron-right"></i></button>',
        dots: true,
        responsive: [{
                breakpoint: 768,
                settings: {
